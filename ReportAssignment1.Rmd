...
We now learn that potassium has a statistically significant effect on the yield with a p-value of 0.02767. From this main effects model we therefore learn that only phosphor does not contribute significantly, we will therefore omit phosphor in subsequent models. 
