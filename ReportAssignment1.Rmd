...
conducted. Since we are considering a small data set, the Shaprio-Wilk
test is fit to assess whether the data set follows a normal
distribution. For the test the null hypothesis is as follows:

H0: The data is normally distributed.

The W-value compares how closely the data follows a normal distribution.
The statistic ranges from 0 to 1, where a value close to 1 indicates
that the data is likely normal. Considering the results for *Before* and
*After8weeks*, both W-values are close to 1. Additionally, assuming a
95% standard error, both p-values exhibit values higher than 0.05. These
two results give significant evidence that suggests the data of both
columns is normally distributed.
