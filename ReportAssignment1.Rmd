...
From the graph we can note that there seems to be a correlation between a higher yield and the presence of the additive Nitrogen in the plot soil. We will further investigate this hypothesis with different tests such as a full two-way ANOVA. The block factor is not of interest but is applied to group plot tests and may introduce variability within the samples.
...
We note that there is a slight deviation at the tail of the normality test. This could be explained by ... We might, however, investigate this further with a Shapiro Wilk test.
