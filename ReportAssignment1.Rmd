...
Tests are met therefore Friedman not neccesary (expand upon): A Friedman test is not neccesary. Although we have introduced random factors with the blocks, it is not fully randomized as we set limitations to the additives per block.
